...
\subsection{Implications for Retrieval Design}
These information needs guided the design and evaluation of the IR experiments described in the subsequent sections. Key focus areas included:
