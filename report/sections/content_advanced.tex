\section{Reaching a Hybrid Search Best Model}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\linewidth]{precision_recall_curve_11pt_avg_only.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\linewidth]{precision_recall_curve_hybrid_alpha_compare.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\linewidth]{frontend1.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{frontend5.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{frontend3.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{frontend2.png}
...
The application is composed of three main modular components to ensure maintainability and responsiveness:
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\linewidth]{frontend4.png}
